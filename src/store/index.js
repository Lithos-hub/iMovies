...
export default new Vuex.Store({
  ...
  actions: {
    ...
    getAction({commit}) {
      ...
      const action = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_action}`;
      
      return new Promise((resolve) => {
        commit('loadingGenre', true)
        axios
        .get(action)
        .then((resp) => {
          commit('loadingGenre', false)
            commit("setAction", resp.data.results)
          ...
          .catch((e) => {
            console.info(e);
            commit('loadingError', "Something wrong happened :( There may have been an error with the database. Please reload the website.")
          });
    ...
    getAdventure({commit}) {
      ...
      const adventure = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_adventure}`;
      ...
      return new Promise((resolve) => {
          ...
          .then((resp) => {
            commit('loadingGenre', false)
              ...
              commit("setAdventure", resp.data.results)
      ...
      const animation = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_animation}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setAnimation", resp.data.results)
      ...
      const comedy = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_comedy}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setComedy", resp.data.results)
      ...
      const crime = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_crime}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setCrime", resp.data.results)
      ...
      getDocumentary({commit}) {

      const genre_documentary = "99";
      const documentary = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_documentary}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setDocumentary", resp.data.results)
      ...
      getDramatic({commit}) {
      const genre_dramatic = "18";
      const dramatic = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_dramatic}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setDramatic", resp.data.results)
      ...
      const fantasy = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_fantasy}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setFantasy", resp.data.results)
      ...
      const history = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_history}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setHistory", resp.data.results)
      ...
      const horror = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_horror}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setHorror", resp.data.results)
      ...
      const genre_musical = "10402";
      const musical = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_musical}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setMusical", resp.data.results)
      ...
      getRomantic({commit}) {
      const genre_romantic = "10749";
      const romantic = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_romantic}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setRomantic", resp.data.results)
      ...
      const scifi = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_scifi}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setScifi", resp.data.results)
      ...
      const thriller = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_thriller}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setThriller", resp.data.results)
      ...
      const war = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_war}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setWar", resp.data.results)
      ...
      const western = `${url}/discover/movie?&api_key=${apikey}&sort_by=popularity.desc&page=1&with_genres=${genre_western}`;
      ...
      return new Promise((resolve) => {
        ...
        .then((resp) => {
          commit('loadingGenre', false)
            ...
            commit("setWestern", resp.data.results)
